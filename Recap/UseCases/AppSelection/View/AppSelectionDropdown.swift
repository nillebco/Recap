        ...
        HStack {
            ...
            Button {
                ...
                Image(systemName: "waveform")
                    ...
                    .foregroundColor(viewModel.isAudioFilterEnabled ? .white : UIConstants.Colors.textTertiary)
            ...
            .background(
                RoundedRectangle(cornerRadius: UIConstants.Sizing.cornerRadius * 0.4)
                    .fill(viewModel.isAudioFilterEnabled ? UIConstants.Colors.textTertiary.opacity(0.2) : Color.clear)
                    .contentShape(Rectangle())
            )
